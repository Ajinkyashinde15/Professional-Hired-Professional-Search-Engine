        ...
        textView_emailid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(OneProfessional.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
                }
        ...
        submitbuttonrating.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    HttpPost httpPost = new HttpPost("http://137.43.93.134/nixerproject/insertuserfeedback.php");
                ...
                JSONObject json = jParser.makeHttpRequest("http://137.43.93.134/nixerproject/selectuserratings.php", "GET", params);
                int count=0;
                double sum=0;
                double avg=0;
                ...
                try {
                    HttpClient httpClient = new DefaultHttpClient();
                    HttpPost httpPost = new HttpPost("http://137.43.93.134/nixerproject/updateratings.php");
                ...
                Intent intent = new Intent(OneProfessional.this, ShowMapStandard.class);
